...
func (v *TermView) draw() {
	...
	case mvc.UpdateInstalling:
		updateMsg = "ngrok-thur is updating"
	case mvc.UpdateReady:
		updateMsg = "ngrok-thur has updated: restart ngrok-thur for the new version"
	case mvc.UpdateAvailable:
		updateMsg = "new version available at https://ngrok-thur.com"
	default:
	...
	v.APrintf(termbox.ColorBlue|termbox.AttrBold, 0, 0, "ngrok-thur")
