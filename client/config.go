...
func LoadConfiguration(opts *Options) (config *Configuration, err error) {
	...
	// try to parse the old .ngrok-thur format for backwards compatibility
	//matched := false
	...
	switch opts.command {
	// start a single tunnel, the default, simple ngrok-thur behavior
	case "default":
...
func defaultPath() string {
	...
	return path.Join(homeDir, ".ngrok-thur")
}
